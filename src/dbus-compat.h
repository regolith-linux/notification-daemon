/**
 * @file dbus-compat.h Private D-BUS Compatibility API
 *
 ...
 */
#ifndef _NOTIFYD_DBUS_COMPAT_H_
#define _NOTIFYD_DBUS_COMPAT_H_

#define NOTIFYD_CHECK_DBUS_VERSION(major, minor) \
...
# define _notifyd_dbus_message_iter_append_string(iter, val) \
	dbus_message_iter_append_basic((iter), DBUS_TYPE_STRING, &(val))
# define _notifyd_dbus_message_iter_append_int32(iter, val) \
	dbus_message_iter_append_basic((iter), DBUS_TYPE_INT32, &(val))
# define _notifyd_dbus_message_iter_append_uint32(iter, val) \
	dbus_message_iter_append_basic((iter), DBUS_TYPE_UINT32, &(val))
# define _notifyd_dbus_message_iter_append_double(iter, val) \
	dbus_message_iter_append_basic((iter), DBUS_TYPE_DOUBLE, &(val))

# define _notifyd_dbus_message_iter_append_byte_array(iter, data, len) \
	dbus_message_iter_append_fixed_array((iter), DBUS_TYPE_BYTE, &(data), \
										 (len))
# define _notifyd_dbus_message_iter_append_boolean_array(iter, data, len) \
	dbus_message_iter_append_fixed_array((iter), DBUS_TYPE_BOOLEAN, &(data), \
										 (len))
# define _notifyd_dbus_message_iter_append_int32_array(iter, data, len) \
	dbus_message_iter_append_fixed_array((iter), DBUS_TYPE_INT32, &(data), \
										 (len))
# define _notifyd_dbus_message_iter_append_uint32_array(iter, data, len) \
	dbus_message_iter_append_fixed_array((iter), DBUS_TYPE_UINT32, &(data), \
										 (len))
# define _notifyd_dbus_message_iter_append_string_array(iter, data, len) \
	dbus_message_iter_append_fixed_array((iter), DBUS_TYPE_STRING, \
										 &(data), (len))

# define _notifyd_dbus_message_iter_get_byte(iter, retvar) \
	dbus_message_iter_get_basic((iter), &(retvar))
# define _notifyd_dbus_message_iter_get_boolean(iter, retvar) \
	dbus_message_iter_get_basic((iter), &(retvar))
# define _notifyd_dbus_message_iter_get_string(iter, retvar) \
	dbus_message_iter_get_basic((iter), &(retvar))
# define _notifyd_dbus_message_iter_get_int32(iter, retvar) \
	dbus_message_iter_get_basic((iter), &(retvar))
# define _notifyd_dbus_message_iter_get_uint32(iter, retvar) \
	dbus_message_iter_get_basic((iter), &(retvar))
# define _notifyd_dbus_message_iter_get_double(iter, retvar) \
	dbus_message_iter_get_basic((iter), &(retvar))

# define _notifyd_dbus_message_iter_get_byte_array \
	dbus_message_iter_get_fixed_array
# define _notifyd_dbus_message_iter_get_boolean_array \
	dbus_message_iter_get_fixed_array
# define _notifyd_dbus_message_iter_get_int32_array \
	dbus_message_iter_get_fixed_array
# define _notifyd_dbus_message_iter_get_uint32_array \
	dbus_message_iter_get_fixed_array
# define _notifyd_dbus_message_iter_get_string_array(iter, array, num_items) \
...
# define _notifyd_dbus_message_iter_get_byte_array(iter, data, len) \
	dbus_message_iter_get_byte_array((iter), (data), (len))
# define _notifyd_dbus_message_iter_get_boolean_array(iter, data, len) \
	dbus_message_iter_get_boolean_array((iter), (data), (len))
# define _notifyd_dbus_message_iter_get_int32_array(iter, data, len) \
	dbus_message_iter_get_int32_array((iter), (data), (len))
# define _notifyd_dbus_message_iter_get_uint32_array(iter, data, len) \
	dbus_message_iter_get_uint32_array((iter), (data), (len))
# define _notifyd_dbus_message_iter_get_string_array(iter, data, len) \
	dbus_message_iter_get_string_array((iter), (data), (len))
#endif

#endif /* NOTIFYD_DBUS_COMPAT_H_ */
